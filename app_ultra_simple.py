"""
NFL Predictions Website - Ultra Simple Version
No redirects, no complex logic - just works
"""
...
@app.route('/')
def index():
    """Home page - always show the form, no redirects"""
    try:
        # Initialize database
        init_db()
        
        # Always show the home page with form
...
def init_database():
    ...
    try:
        ...
        return render_template('index.html', message="Database initialization attempted")
    except Exception as e:
        logger.error(f"Manual database init error: {e}")
        flash('Database initialization error!', 'error')
        return render_template('index.html', message="Database initialization error")
...
def week_predictions(week):
    ...
    try:
        ...
        try:
            ...
            return render_template('index.html', message="Database not initialized")
        ...
        return render_template('index.html', message="Error loading predictions")
...
def stats():
    ...
    try:
        ...
        return render_template('index.html', message="Error loading statistics")
