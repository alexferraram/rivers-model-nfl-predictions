...
class RiversModel:
    ...
    def __init__(self):
        ...
        # RIVERS Model weights (removed 5% injury weight, redistributed)
        self.weights = {
            'enhanced_epa': 0.26,        # EPA enhanced with PFF player grades
            'enhanced_efficiency': 0.26,  # Efficiency enhanced with PFF execution grades
            'enhanced_yards': 0.21,      # Yards enhanced with PFF YAC/air yards
            'enhanced_turnovers': 0.21,   # Turnovers enhanced with PFF ball security
    ...
    def calculate_team_score(self, team_abbr: str, week: int = 3) -> Dict:
        """
    ...
    def predict_game(self, home_team: str, away_team: str, week: int = 3) -> Dict:
        ...
        try:
            ...
            home_score_data = self.calculate_team_score(home_team, week)
            away_score_data = self.calculate_team_score(away_team, week)
    ...
    def get_week3_schedule(self) -> List[Dict]:
        ...
        return [
            ...
            {'home': 'PHI', 'away': 'NO', 'time': 'Sunday 1:00 PM'},
            {'home': 'DAL', 'away': 'NYG', 'time': 'Sunday 1:00 PM'},
            {'home': 'WAS', 'away': 'CHI', 'time': 'Sunday 1:00 PM'},
            {'home': 'DET', 'away': 'GB', 'time': 'Sunday 1:00 PM'},
            {'home': 'MIN', 'away': 'ATL', 'time': 'Sunday 1:00 PM'},
            {'home': 'CAR', 'away': 'TB', 'time': 'Sunday 1:00 PM'},
            {'home': 'ARI', 'away': 'LAR', 'time': 'Sunday 4:05 PM'},
            {'home': 'SF', 'away': 'SEA', 'time': 'Sunday 4:05 PM'},
            {'home': 'BAL', 'away': 'CIN', 'time': 'Sunday 4:25 PM'},
            {'home': 'CLE', 'away': 'PIT', 'time': 'Sunday 4:25 PM'},
            {'home': 'HOU', 'away': 'IND', 'time': 'Sunday 4:25 PM'},
            {'home': 'JAX', 'away': 'TEN', 'time': 'Sunday 4:25 PM'},
            {'home': 'DEN', 'away': 'KC', 'time': 'Sunday 4:25 PM'},
            {'home': 'LV', 'away': 'LAC', 'time': 'Sunday 4:25 PM'},
            {'home': 'NE', 'away': 'NYJ', 'time': 'Sunday 8:20 PM'}
        ]
...
if __name__ == "__main__":
    ...
    print("🌊 RIVERS MODEL - Week 3 NFL Predictions")
    print("=" * 60)
    print("Enhanced model with dynamic injury system")
    print("=" * 60)
    
    rivers_model = RiversModel()
    
    # Get Week 3 schedule
    week3_games = rivers_model.get_week3_schedule()
    ...
    for game in week3_games:
        prediction = rivers_model.predict_game(game['home'], game['away'], week=3)
        predictions.append(prediction)
        rivers_model.display_prediction(prediction)
